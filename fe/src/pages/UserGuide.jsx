  ...
  const sections = [
    {
      ...
      content: [
        {
          subtitle: "Apa itu Persona Flow Insight?",
          description:
            "Platform ini menganalisis pola belajar kamu menggunakan AI untuk memberikan insight personal dan rekomendasi yang actionable.",
        },
        {
    ...
    },
    {
      ...
      performanceFields: [
        {
          ...
          explanation:
            "Rata-rata waktu yang kamu habiskan untuk menyelesaikan satu modul pembelajaran (dalam menit).",
          example:
            "Contoh: 25 menit = kamu biasanya belajar 25 menit per modul",
        ...
        },
        {
          ...
          explanation:
            "Persentase aktivitas belajar yang dilakukan di weekend (Sabtu-Minggu).",
          example:
        ...
        },
        {
          ...
          explanation:
            "Kategori durasi belajar: 1 = Singkat (<15 min), 2 = Sedang (15-30 min), 3 = Lama (>30 min)",
      ...
      clusteringFields: [
        ...
        },
        {
          ...
          icon: <Clock className="w-5 h-5 text-purple-600" />,
          explanation:
            "Sama seperti di Performance Features. Rata-rata waktu belajar per modul.",
        ...
        },
        {
          ...
          icon: <Target className="w-5 h-5 text-orange-600" />,
          explanation:
            "Sama seperti di Performance Features. Persentase belajar di weekend.",
          ...
          interpretation: [
            {
              ...
              level: "Excellent",
              description:
                "Performa sangat baik! Terus pertahankan pola belajar kamu.",
            },
            {
              score: "3.0 - 3.9",
              level: "Good",
              description:
                "Performa bagus, ada sedikit ruang untuk improvement.",
            },
            {
              score: "2.0 - 2.9",
              level: "Average",
              description:
                "Performa cukup, perlu fokus pada konsistensi dan aktivitas.",
            },
            {
              score: "< 2.0",
              level: "Needs Work",
              description:
                "Performa perlu ditingkatkan, ikuti rekomendasi yang diberikan.",
            },
          ],
        },
        {
          ...
          personas: [
            {
              name: "The Consistent",
              description:
                "Kamu belajar dengan pola yang stabil dan teratur. Kedisiplinan adalah kekuatan kamu.",
            ...
            },
            {
              name: "The Sprinter",
              description:
                "Kamu cepat memahami materi dan menyelesaikan banyak aktivitas dalam waktu singkat.",
            ...
            },
            {
              name: "The Warrior",
              description:
                "Kamu punya semangat tinggi dan tidak takut menghadapi materi yang challenging.",
    ...
    },
    {
      ...
      progressGuide: [
        ...
        },
        {
          color: "Yellow (50-79%)",
          meaning:
            "Good! Ada ruang untuk improvement, tapi kamu on the right track.",
        },
        {
          color: "Red (0-49%)",
          meaning:
            "Needs Attention! Fokus pada area ini untuk hasil yang lebih baik.",
        },
      ],
    },
    {
    ...
    },
    {
      ...
      comparison: [
        ...
        },
        {
          ...
          example:
            "Contoh: 'Lebih tinggi 15%' = Kamu 15% lebih baik dari The Consistent",
        },
      ],
    },
  ];
        ...
        <div className="flex items-center gap-4 mb-4">
          ...
          <div>
            ...
            <p className="text-gray-600 text-lg mt-2">
              Panduan lengkap untuk memahami dan menggunakan Persona Flow
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-gradient-to-r from-blue-500 to-cyan-500 rounded-3xl p-6 text-white mb-8 shadow-xl">
        ...
        <ul className="space-y-2 text-sm">
          <li className="flex items-center gap-2">
            ...
            <span>
              Gunakan tombol <strong>Auto-Fill</strong> untuk coba sample data
            </span>
          </li>
          <li className="flex items-center gap-2">
            <CheckCircle className="w-4 h-4 flex-shrink-0" />
            <span>
              Fokus pada rekomendasi <strong>High Priority</strong> terlebih
              dahulu
            </span>
          </li>
          <li className="flex items-center gap-2">
            <CheckCircle className="w-4 h-4 flex-shrink-0" />
            <span>
              Check <strong>Dashboard</strong> untuk lihat benchmark dan
              comparison
            </span>
          </li>
          <li className="flex items-center gap-2">
          ...
          <li className="flex items-center gap-2">
            <CheckCircle className="w-4 h-4 flex-shrink-0" />
            <span>
              <strong>Semua data selalu positif</strong> - tidak ada angka minus
              yang membingungkan!
            </span>
          </li>
        </ul>
      ...
      <div className="space-y-6">
        ...
        <div className="bg-white rounded-3xl p-8 shadow-lg border border-gray-100">
          <div className="flex items-center gap-3 mb-6">
            <div
              className={`w-12 h-12 bg-gradient-to-r ${sections[0].color} rounded-xl flex items-center justify-center text-white shadow-md`}
            >
              {sections[0].icon}
            </div>
        ...
        <div className="bg-white rounded-3xl p-8 shadow-lg border border-gray-100">
          <div className="flex items-center gap-3 mb-6">
            <div
              className={`w-12 h-12 bg-gradient-to-r ${sections[1].color} rounded-xl flex items-center justify-center text-white shadow-md`}
            >
              {sections[1].icon}
            </div>
            <h2 className="text-2xl font-bold text-gray-800">
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-600 mb-6">
              Field-field ini digunakan untuk memprediksi performa belajar kamu.
              Isi dengan data aktivitas belajar kamu yang sebenarnya.
            </p>
          ...
          <div className="border-t-2 border-gray-200 pt-8">
            ...
            <p className="text-gray-600 mb-4">
              Field-field ini digunakan untuk mengidentifikasi{" "}
              <strong>Student Persona</strong> kamu (The Consistent, The
              Sprinter, The Warrior).
            </p>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <ul className="text-yellow-800 text-sm space-y-1 ml-4">
                    <li>
                      • Performance Features → Prediksi{" "}
                      <strong>skor performa</strong>
                    </li>
                    <li>
                      • Clustering Features → Identifikasi{" "}
                      <strong>tipe learner</strong>
                    </li>
                  </ul>
                </div>
              </div>
        ...
        <div className="bg-white rounded-3xl p-8 shadow-lg border border-gray-100">
          <div className="flex items-center gap-3 mb-6">
            <div
              className={`w-12 h-12 bg-gradient-to-r ${sections[2].color} rounded-xl flex items-center justify-center text-white shadow-md`}
            >
              {sections[2].icon}
            </div>
            <h2 className="text-2xl font-bold text-gray-800">
        ...
        <div className="bg-white rounded-3xl p-8 shadow-lg border border-gray-100">
          <div className="flex items-center gap-3 mb-6">
            <div
              className={`w-12 h-12 bg-gradient-to-r ${sections[3].color} rounded-xl flex items-center justify-center text-white shadow-md`}
            >
              {sections[3].icon}
            </div>
            <h2 className="text-2xl font-bold text-gray-800">
        ...
        <div className="bg-white rounded-3xl p-8 shadow-lg border border-gray-100">
          <div className="flex items-center gap-3 mb-6">
            <div
              className={`w-12 h-12 bg-gradient-to-r ${sections[4].color} rounded-xl flex items-center justify-center text-white shadow-md`}
            >
              {sections[4].icon}
            </div>
            <h2 className="text-2xl font-bold text-gray-800">
        ...
        <div className="bg-white rounded-3xl p-8 shadow-lg border border-gray-100">
          <div className="flex items-center gap-3 mb-6">
            <div
              className={`w-12 h-12 bg-gradient-to-r ${sections[5].color} rounded-xl flex items-center justify-center text-white shadow-md`}
            >
              {sections[5].icon}
            </div>
            <h2 className="text-2xl font-bold text-gray-800">
          ...
          <div className="mt-6 border-t-2 border-gray-200 pt-6">
            ...
            <div className="bg-gray-50 rounded-2xl p-4 border border-gray-200">
              ...
              <p className="text-sm text-gray-600">
                Artinya: Performa kamu <strong>mirip/sama</strong> dengan
                benchmark persona ini. Kamu sudah on track! 👍
              </p>
            </div>
          </div>
        </div>
